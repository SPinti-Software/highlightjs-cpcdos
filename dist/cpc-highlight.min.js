/*
  Highlight.js 10.0.0-beta.0 (864b7028)
...
hljs.registerLanguage("cpc",function(){"use strict";return function(e){return{name:"CPCDOSC+",aliases:["cpc","CPC","ccp","CCP","cpcdosc+"],case_insensitive:!0,keywords:{lexemes:"[a-z]+\\/",keyword:"txt cls fix set couleurc colorf couleurf colorb exe cmd ccp aide help pos stopk stop sys aller goto si if rep dir copier copy supprimer delete renommer rename dossier folder ouvrir open ecrire write fermer close retour return fonction function declarer declare ping telecharger download serveur server client demarrer start iug gui message msgbox fenetre window imagebox picturebox bouton button textebloc textblock checkbox barreprogression progressbar end"},contains:[{className:"keyword",begin:"(end|fin)\\/\\s(if|si|function|fonction|fenetre|window|bouton|button|imagebox|picturebox|textebloc|textblock|checkbox|barreprogression|progressbar)"},{className:"keyword",begin:"(sinon|else|alors|then):"},{className:"number",begin:"[0-9]+"},{className:"variable",begin:"%[a-zA-Z][a-zA-Z0-9]+%"},e.QUOTE_STRING_MODE,e.COMMENT("REM","$",{relevance:10}),e.COMMENT("'","$",{relevance:10}),e.COMMENT("\\/\\/","$",{relevance:10})]}}}());